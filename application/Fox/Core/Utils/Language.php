...
class Language
{
    ...
    public function __construct(File\Manager $fileManager, Config $config, Metadata $metadata, \Fox\Entities\Preferences $preferences = null)
    {
        ...
        $this->unifier = new \Fox\Core\Utils\File\Unifier($this->fileManager, $this->metadata);
    }
