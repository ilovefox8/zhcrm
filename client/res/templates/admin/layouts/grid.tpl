...
<style>
    ...
    #layout ul.panels ul.cells > li[data-full-width="4"] {
        width: 94%;
    }

    #layout ul.panels ul.cells > li[data-full-width="3"] {
        width: 68%;
    }

    #layout ul.panels ul.cells > li[data-full-width="2"] {
        width: 46%;
    }
            ...
            <li>
                ...
                <%
                    ...
                    for (var j in row) {
                        ...
                        if (cell !== false) {
                %>
                        <li class="cell" data-no="<%= i %>" data-name="<%= cell.name %>" data-full-width="<%= cell.fullWidth || '' %>"><%= cell.label %>
                            <a href="javascript:" data-action="removeField" class="remove-field"><i class="glyphicon glyphicon-remove"></i></a>                                                        
                        </li>
                <%            
                        } else {
                %>
                        <li class="empty cell"  data-no="<%= i %>" >
    ...
    <li>
        ...
        <ul class="cells">
            <% for (var i = 0; i < {{columnCount}}; i++) { %>
                <li class="empty cell" data-no="<%= i%>"><a href="javascript:" data-action="minusCell" class="remove-field"><i class="glyphicon glyphicon-minus"></i></a></li>
            <% } %>
        </ul>
    </li>
</div>
